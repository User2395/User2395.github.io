...
function draw() {
  ...
  fill(255);
  text("Athens 2022",windowWidth/2.2,windowHeight/1.7);

  fill(128,255,128);
  text(`${days}:${hours}:${minutes}:${seconds}`,windowWidth/2.2,windowHeight/1.4);

  textSize(12);
  text(`DAYS  HOURS  MINUTES SECONDS`,windowWidth/2.2,windowHeight/1.5);

	image(img,windowWidth/2.6,windowHeight/6,img.width/2,img.height/2);
}
